...
const baseUrl='https://localhost:7208/api/consolas'
...
const styles= useStyles();
  ...
  const peticionPut=async()=>{
    await axios.put(baseUrl+'?id='+consolaSeleccionada.id, consolaSeleccionada)
    .then(response=>{
      var dataNueva=data;
  ...
  const peticionDelete=async()=>{
    await axios.delete(baseUrl+'?id='+consolaSeleccionada.id)
    .then(response=>{
